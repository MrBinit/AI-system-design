...
- Secret value must be JSON object keys matching expected env names (for example `AWS_ACCESS_KEY_ID`, `AWS_SECRET_ACCESS_KEY`, `POSTGRES_PASSWORD`, `SECURITY_JWT_SECRET`, `SECURITY_JWT_AUDIENCE`, `MEMORY_ENCRYPTION_KEY`, `BEDROCK_TIMEOUT`).
